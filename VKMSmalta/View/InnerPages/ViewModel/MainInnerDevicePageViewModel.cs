                ...
                Elements = new ObservableCollection<ElementViewModelBase>
                       {
                           ...
                           GiveMe.Element().On(PageKey).WithName("l001p_button_reciever_glow_off").WithValueFrom(currentAlgorithm.StartStateOfElements).At(655,462).BigButton(historyService)
                                 .WithDependencyAction(GiveMe.DependencyAction()
                                                             ...
                                                             .Please())
                                 .Please(),
                           GiveMe.Element().On(PageKey).WithName("l001p_button_transmitter_on").WithValueFrom(currentAlgorithm.StartStateOfElements).At(580,554).BigButton(historyService).Please(),
                           ...
                           GiveMe.Element().On(PageKey).WithName("l001p_transmitter_4channel_arrow").WithValueFrom(currentAlgorithm.StartStateOfElements).WithStartupRotation(35).At(667,1001).LittleArrow().Please(),
                       };
            }
