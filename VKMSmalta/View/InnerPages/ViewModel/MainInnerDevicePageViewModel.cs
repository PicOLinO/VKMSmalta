                ...
                Elements = new ObservableCollection<ElementViewModelBase>
                           {
                               ...
                               GiveMe.Element().On(PageKey).WithName("l001i_thumbler_2generator").WithValueFrom(currentAlgorithm.StartStateOfElements).At(302,523).Thumbler(historyService)
                                     ...
                                     .WithDependencyAction(GiveMe.DependencyAction()
                                                                 ...
                                                                 .Please())
                                     .Please(),
                               GiveMe.Element().On(PageKey).WithName("l001i_thumbler_3generator").WithValueFrom(currentAlgorithm.StartStateOfElements).At(443,364).Thumbler(historyService)
                                     .WithDependencyAction(GiveMe.DependencyAction()
                                                                 .TypeOf(DependencyType.Add)
                                                                 .WithDependencyElementName("l001p_reciever_1channel_arrow")
                                                                 .WithDependencyValue(0, -5)
                                     ...
                                     .WithDependencyAction(GiveMe.DependencyAction()
                                                                 ...
                                                                 .Please())
                                     .Please(),
                               GiveMe.Element().On(PageKey).WithName("l001i_thumbler_4generator").WithValueFrom(currentAlgorithm.StartStateOfElements).At(439,524).Thumbler(historyService)
                                     .WithDependencyAction(GiveMe.DependencyAction()
                                                                 .TypeOf(DependencyType.Add)
                                                                 .WithDependencyElementName("l001p_reciever_1channel_arrow")
                                                                 .WithDependencyValue(0, -5)
